 ...
 * @param chrom_index, a index points to the current chromosome index at the chromo_tracking array variable
 */
void processRecord(User_Input *user_inputs, Stats_Info *tmp_stats_info, bam1_t *rec, Chromosome_Tracking *chrom_tracking, uint32_t chrom_index, Breakpoint_Array *breakpoint_array, khash_t(khStrInt) *breakpoint_pairs_hash);
